...
using KMMobile.ZipLib.Encryption;
#endif

using KMMobile.ZipLib.Core;
using KMMobile.ZipLib.Checksums;
using KMMobile.ZipLib.Zip.Compression.Streams;
using KMMobile.ZipLib.Zip.Compression;

namespace KMMobile.ZipLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="KMMobile.ZipLib.Zip.ZipException">
